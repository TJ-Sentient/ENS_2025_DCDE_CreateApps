...
namespace UTool.TabSystem
{
    ...
    public class TVariable
    {
        ...
        [BeginGroup]
        [ShowIf(nameof(controlledByAttribute),true)][NewLabel("Variable Name")][Disable] public string attVariableName;
        [HideIf(nameof(controlledByAttribute),false)][NewLabel("Variable Name")][SearchableEnum] public TabVariableName tVariableName;
        ...
        [JsonIgnore][NewLabel("Default Value"), ShowIf(nameof(isStringVar),true)] public string defaultStringValue;
        [JsonIgnore][NewLabel("Default Value"), ShowIf(nameof(isFloatVar),true)] public float defaultFloatValue;
        [JsonIgnore][NewLabel("Default Value"), ShowIf(nameof(isIntVar),true)] public int defaultIntValue;
        [JsonIgnore][NewLabel("Default Value"), ShowIf(nameof(isBoolVar),true)] public bool defaultBoolValue;
        [JsonIgnore][NewLabel("Default Value"), ShowIf(nameof(isVector3Var),true)] public Vector3 defaultVector3Value;
        [JsonIgnore][NewLabel("Default Value"), ShowIf(nameof(isVector2Var),true)] public Vector2 defaultVector2Value;
        ...
        [NewLabel("Value"), ShowDisabledIf(nameof(isStringVar),false)]              public string  stringValue;
        [NewLabel("Value"), ShowDisabledIf(nameof(isFloatVar),false)]               public float   floatValue;
        [NewLabel("Value"), ShowDisabledIf(nameof(isIntVar),false)]                 public int     intValue;
        [NewLabel("Value"), ShowDisabledIf(nameof(isBoolVar),false)]                public bool    boolValue;
        [JsonIgnore][NewLabel("Value"), ShowDisabledIf(nameof(isVector3Var),false)] public Vector3 vector3Value;
        [JsonIgnore][NewLabel("Value"), ShowDisabledIf(nameof(isVector2Var),false)] public Vector2 vector2Value;
        ...
        [JsonIgnore][ShowIf(nameof(isTriggerVar),true)] public UnityEvent OnValueTrigger = new UnityEvent();
        [SpaceArea]
        [EndGroup]
        [JsonIgnore][HideIf(nameof(isTriggerVar),false)] public UnityEvent<VariableUpdateType, TVariable> OnValueUpdate = new UnityEvent<VariableUpdateType, TVariable>();
