...
namespace UTool.TabSystem
{
    ...
    {
        [BeginGroup]
        [ShowIf(nameof(controlledByAttribute),true)][NewLabel("Tab Name")][Disable] public string attTabName;
        [HideIf(nameof(controlledByAttribute),false)][NewLabel("Tab Name")][SearchableEnum] public TabName tTabName;
