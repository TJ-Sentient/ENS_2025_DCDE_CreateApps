...
namespace UTool.Utility
{
    public static partial class UUtility
    {
        ...
        public static void Crop(this Texture2D texture, int xPos, int yPos, int newWidth, int newHeight, Action<Texture2D> callback, bool returnNewTexture = false)
            => texture.Crop(new Vector2Int(xPos, yPos), new Vector2Int(newWidth, newHeight), callback, returnNewTexture);

        public static void Crop(this Texture2D texture, Vector2Int position, Vector2Int size, Action<Texture2D> callback, bool returnNewTexture = false)
        {
            texture.Crop(Vector2.one * 0.5f, position, Vector2.one * 0.5f, size, callback, returnNewTexture);
        }

        public static void Crop(this Texture2D texture, Vector2 positionPivot, Vector2Int position, Vector2 sizePivot, Vector2Int size, Action<Texture2D> callback, bool returnNewTexture = false)
        {
            CropTexture(texture, positionPivot, position, sizePivot, size, callback, returnNewTexture);
        }
        ...
        public static void CropTexture(Texture2D sourceTexture, Vector2 positionPivot, Vector2Int position,
                                                                Vector2 sizePivot, Vector2Int size,
                                                                Action<Texture2D> callback, bool returnNewTexture = false)
        {
